...
function cargarEventListner(){
    elementos1.addEventListener('click', comprarElemeto);
    elementos2.addEventListener('click', comprarElemeto);
    elementos3.addEventListener('click', comprarElemeto);
...
function eliminarElemnto(e){
    ...
    if(e.target.classList.contains('borrar')){
        ...
        elemento = elemento.querySelector('a').getAttibute('data-id');
    }
